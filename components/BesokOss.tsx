  ...
  return (
    ...
    >
      <img
        ...
        className="z-50 pointer-events-none absolute left-1/3 -top-80 w-24 -translate-x-1/3 -scale-x-90  sm:w-100"
        alt=""
      />
      <img
        src="/ekke_img/sparkle.png"
        className="pointer-events-none absolute  left-4 w-24 -scale-x-100 -top-10 sm:left-40 sm:w-50"
        alt=""
      />
      <img
        src="/ekke_img/sparkle.png"
        className="pointer-events-none absolute left-1/3 bottom-8 w-24 -translate-x-1/3 sm:bottom-5 sm:w-40"
        alt=""
      />
      <img
        src="/ekke_img/cheers.png"
        className="z-50 pointer-events-none absolute right-30 -bottom-10 w-24 scale-x-90  sm:w-90"
        alt=""
      />
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="flex flex-col gap-6 ">
          ...
          <div className="rounded-lg bg-secondary-bg p-8 text-primary shadow-sm sm:p-10">
            ...
            <p className="text-foreground/70">Gatuadress 1, 123 45 Stad</p>
          </div>
          <div>
            <h3 className="text-xs font-medium uppercase tracking-[0.25em] text-primary/70">
              Öppettider
            ...
            <ul className="mt-2 space-y-1 text-foreground/70">
              <li>Mån–Tor: 16:00–23:00</li>
              <li>Fre–Lör: 15:00–01:00</li>
              <li>Sön: 15:00–22:00</li>
            </ul>
          </div>
          <div>
            <h3 className="text-xs font-medium uppercase tracking-[0.25em] text-primary/70">
            ...
            <p className="mt-2 text-foreground/70">hello@ekkebar.se</p>
          </div>
        </div>
      </div>
    </section>
